...
<template>
  <Teleport to="body">
    ...
    >
      <div
        class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-200 border border-gray-100 overflow-hidden"
      >
        <div
        ...
        >
          ...
          <button
            @click="$emit('close')"
            class="text-gray-400 hover:text-gray-600 p-1 hover:bg-gray-200 rounded-full transition-colors"
          >
            <X class="w-5 h-5" />
          </button>
        </div>
          ...
          <form @submit.prevent="handleSubmit" id="checklistForm" class="space-y-5">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div class="space-y-1.5 md:col-span-3">
                ...
                <input
                  ...
                  class="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#38b6ff] transition-all text-sm"
                  required
                />
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div class="space-y-1.5">
                ...
                <input
                  type="number"
                  v-model="form.order"
                  class="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#38b6ff] transition-all text-sm font-mono"
                  required
                />
              </div>
            </div>
            ...
            <div class="space-y-1.5">
              ...
              <textarea
                ...
                rows="3"
                placeholder="..."
                class="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#38b6ff] transition-all text-sm resize-none"
              ></textarea>
            </div>
              ...
              <div class="space-y-3">
                ...
                <div class="flex items-center gap-3">
                  <button
                    ...
                    :class="form.isRequired ? 'bg-[#38b6ff]' : 'bg-gray-200'"
                  >
                    <span
              ...
              <div class="space-y-3">
                ...
                <div class="flex items-center gap-3">
                  <button
                    ...
                    "
                    class="relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none"
                    :class="form.status === 'active' ? 'bg-emerald-500' : 'bg-gray-200'"
                  >
                    <span
                      class="pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out"
                      :class="
                  ...
                  <span
                    ...
                    :class="
                      form.status === 'active' ? 'text-emerald-600' : 'text-gray-500'
                    "
                  >
        ...
        <div
          class="px-6 py-4 border-t border-gray-100 bg-gray-50/50 flex justify-end gap-3 flex-shrink-0"
        >
          <button
            type="button"
            @click="$emit('close')"
            class="px-6 py-2.5 text-gray-600 bg-white border border-gray-200 hover:bg-gray-50 rounded-xl text-sm font-medium transition-colors"
          >
            ยกเลิก
          </button>
          <button
            ...
            form="checklistForm"
            :disabled="saving"
            class="px-6 py-2.5 bg-[#38b6ff] hover:bg-[#38b6ff]/90 text-white rounded-xl text-sm font-medium shadow-lg shadow-blue-100 transition-colors flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
          >
