...
<template>
  <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden flex flex-col h-[calc(100vh-320px)]">
    ...
    <div v-if="!loading && totalItems > 0" class="border-t border-gray-200 p-4 bg-white z-20 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-600">
