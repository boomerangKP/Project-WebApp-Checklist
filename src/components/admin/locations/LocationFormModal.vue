...
<template>
  <div v-if="isOpen" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in">
    ...
    <div class="bg-white w-full max-w-lg rounded-2xl shadow-xl overflow-visible animate-in zoom-in-95 relative z-[70]">
      ...
      <form @submit.prevent="handleSubmit" class="p-6 space-y-5">
        ...
        <div class="grid grid-cols-2 gap-4">
           ...
           <div class="space-y-1 relative">
             ...
             <div v-if="showBuildingDropdown" class="absolute top-full left-0 w-full mt-1 bg-white border border-gray-200 rounded-xl shadow-lg z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-100">
           ...
           <div class="space-y-1 relative">
             ...
             <div v-if="showFloorDropdown" class="absolute top-full left-0 w-full mt-1 bg-white border border-gray-200 rounded-xl shadow-lg z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-100">
                <div class="p-2 border-b border-gray-100">
